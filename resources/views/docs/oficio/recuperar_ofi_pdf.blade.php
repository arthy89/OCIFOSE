...
<div style="font-family: 'Times New Roman', Times, serif">
    <div class="row">
        ...
        <div class="col-md-12" style="text-align: left">
            <h5 class="ofi-title">@if(strlen($oficio_act[0]->ofi_num) == 1)
                   <u><b> OFICIO N° 00{{$oficio_act[0]->ofi_num}}-2023-GRP/DREP-OCI</b></u> 
                @elseif(strlen($oficio_act[0]->ofi_num) == 2)
                    <u><b> OFICIO N° 0{{$oficio_act[0]->ofi_num}}-2023-GRP/DREP-OCI</b></u>
                @elseif(strlen($oficio_act[0]->ofi_num) == 3)
                    <u><b> OFICIO N° {{$oficio_act[0]->ofi_num}}-2023-GRP/DREP-OCI</b></u>
                @endif 
            </h5>
            <br>
        </div>
        ...
        <div class="col-md-8">
            <p class="ofi-text-min">INFORME DE HITO DE CONTROL N° @if(strlen($oficio_act[0]->ofi_num) == 1)
                                00{{$oficio_act[0]->ofi_num}}
                            @elseif(strlen($oficio_act[0]->ofi_num) == 2)
                                0{{$oficio_act[0]->ofi_num}}
                            @elseif(strlen($oficio_act[0]->ofi_num) == 3)
                                {{$oficio_act[0]->ofi_num}}
        ...
        <div class="col-md-12">
            <p class="ofi-text">{{$oficio_act[0]->ofi_body}}</p>
            <p class="ofi-text">Al respecto, como resultado de la ejecución del citado servicio relacionado, ha emitido el informe <strong>INFORME DE HITO DE CONTROL N° @if(strlen($oficio_act[0]->ofi_num) == 1)
                                00{{$oficio_act[0]->ofi_num}}
                            @elseif(strlen($oficio_act[0]->ofi_num) == 2)
                                0{{$oficio_act[0]->ofi_num}}
                            @elseif(strlen($oficio_act[0]->ofi_num) == 3)
